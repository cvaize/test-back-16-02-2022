...
public function DataOpen(&$Query,$QryPrms=false) {
	...
	case 6: // MySQL
		switch ($this->SubType) {
		case 0: $this->RecSet = @mysqli_query($Query,$this->SrcId); break;
		case 1: $this->RecSet = $this->SrcId; break;
		case 2: $this->RecSet = @mysqli_query($Query); break;
		}
		if ($this->RecSet===false) $this->DataAlert('MySql error message when opening the query: '.mysqli_error());
		break;
	case 1: // Num
		$this->RecSet = true;
		$this->NumMin = 1;
...
private function _DataFetchOn($obj) {
	...
	switch ($this->Type) {
	case 6: // MySQL
		$obj->CurrRec = mysqli_fetch_assoc($this->RecSet);
		break;
	case 1: // Num
